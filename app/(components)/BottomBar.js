...
export default function BottomBar({
  ...
  return (
    <div
      ...
      className='fixed z-10 md:h-1/3 h-auto md:w-auto w-full bg-accent border-t-2 border-[#C4AC83]  md:top-1/3 bottom-0 items-center justify-between text-white p-3 rounded-lg flex md:flex-col gap-3'
    >
      <button
